...
<form id="itemupdate" action="../update/corp.com" method="post" encType="multipart/form-data">
	...
	<table border="1" width="200">
		...
		<tr>
			...
			<th><input type="text" id="iname" name="iname" value="${IDTO.iname}" placeholder="상품명을 입력해주세요" style="width:300px; required="required"></th>
		</tr>
		<tr>
			<th><label for="icategory">카테고리: </label></th>
			<th>
			<select id="icategory" name="icategory">
    			<option value="${IDTO.icategory}">선택</option>
		...
		<tr>
			...
			<th><input type="text" id="iprice" name="iprice" value="${IDTO.iprice}" placeholder="가격을 입력해주세요" style="width:300px; required="required"></hd>
		</tr>
		<tr>
		...
		<tr>
			...
			<th><input type="text" id="istock" name="istock" value="${IDTO.istock}" placeholder="재고를 입력해주세요" style="width:300px; required="required"></td>
		</tr>
		<tr>
			<th><label for="idetail">상세설명: </label></th>
			<th><input type="text" id="idetail" name="idetail" value="${IDTO.idetail}" style="width:300px; placeholder="제품에 대한 설명을 입력해주세요" ></td>
		</tr>
