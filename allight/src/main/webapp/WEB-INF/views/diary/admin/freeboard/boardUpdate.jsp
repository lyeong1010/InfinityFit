...
<script>
	$(function() {
		...
		$("#update").click(function() {
			$("#form").attr("action","${pageContext.request.contextPath}/freeboard/update/admin.com?no=${DETAIL.fno}");
			$("#form").submit();
		});
		//목록 버튼 클릭 시
		$("#list").click(function() {
		...
		//취소 버튼 클릭 시
		$("#back").click(function() {
			$(location).attr("href","${pageContext.request.contextPath}/freeboard/detail/admin.com?no=${DETAIL.fno}");
		});
