      ...
      <div class="center">
         <ul class="pagination" id="Page">
            <li>
               ...
               <c:if test="${PINFO.nowPage <= 3}">
                  <a href="${pageContext.request.contextPath}/cal/dictionary/exercise.com?nowPage=1">«</a>
               </c:if>
            </li>
            <!-- 현재 페이지일때 active --> 
            <c:forEach begin="${PINFO.startPage}" end="${PINFO.endPage}" var="i">
               <li id="li"><!-- 스크립트 적용해야 할것같아요 -->
                  <a href="${pageContext.request.contextPath}/cal/dictionary/exercise.com?nowPage=${i}&searchWord=${searchWord}">${i}</a>
               </li>
            </c:forEach>            
            <li>
               ...
               <c:if test="${PINFO.nowPage >= PINFO.endPage-2}">
                  <a href="${pageContext.request.contextPath}/cal/dictionary/exercise.com?nowPage=${PINFO.endPage}&searchWord=${searchWord}">»</a>
               </c:if>
            </li>
         </ul>
      </div>
