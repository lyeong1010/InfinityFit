...
<table>
	...
	<tr>
		...
		</select>&nbsp;- <input id="mtel1" type="text" name="mtel1" maxlength="4" size="5" value="${param.mtel1}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
		&nbsp;- <input id="mtel2" type="text" name="mtel2" maxlength="4" size="5" value="${param.mtel2}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></td>
	</tr>
	<tr>
		<td>성별</td>
...
<div class="box-wrap">
	<ul class="join-msg">
		<li><label><input type="checkbox" id="mem_age_chk"name="mem_age_chk" value="Y"> <b>만 14세 이상입니다. (필수)</b></label></li>
		<li>* 만 14세 미만의 아동은 회원가입 시 법적대리인의 동의가 필요합니다. 회원가입이 필요할 시 당사
			고객센터로 연락해주세요.</li>
		<li>* 회원가입에 필요한 최소한의 정보만 입력 받음으로써 고객님의 개인정보 수집을 최소화하고 편리한 회원가입을
			제공합니다.</li>
	</ul><hr/>
	
	<fieldset style="width:100%; border:none; float:none; ">
		<div class="new-privercy-contract">
			<div id="chkwrap">
				<div class="all-chk">
					<label><input type="checkbox" name="every_agree" id="every_agree" value="all" class="every_agree" checked="checked">
						전체동의</label> <input type="hidden" name="allnew_agree" id="allnew_agree" value="Y">
				</div>
				<div class="cboxes">
					<ul>
						<li class="ml-30 pt-10">
							<label>
								<input type="checkbox" name="yaok2" id="yaok2" value="Y" class="yaok2" checked="checked"> 이용약관
							<a href="#chk_cont1" style="color:grey">내용보기</a>
							</label>
						</li>
						<li class="ml-30 pt-10">
							<label>
								<input type="checkbox" name="privacy1" id="privacy1" value="agree_uidB" class="privacy1" checked="checked">
								개인정보 수집 및 이용 안내
								<a href="#chk_cont2" style="color:grey">내용보기</a>
							</label>
						</li>
						<li class="ml-30 pt-10">
							<label>
								<input type="checkbox" name="privacy2" id="privacy2" value="agree_uidC" class="privacy2" checked="checked">
									개인정보 제3자 제공
								<a href="#chk_cont3" style="color:grey">내용보기</a>
							</label>
						</li>
					</ul>
				</div>
		...
		<div class="privercy-contract">
			<textarea cols="80" wrap="off" rows="10">
인터넷 쇼핑몰 『(주)Allight 사이버 몰』회원 약관
			
제1조(목적)
이 약관은 (주)Allight(전자상거래 사업자)가 운영하는 (주)Allight 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
	※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)
① “몰”이란 (주)Allight회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
② “이용자”란 “몰”에 접속하여 이 약관에 따라 “몰”이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
③ ‘회원’이라 함은 “몰”에 회원등록을 한 자로서, 계속적으로 “몰”이 제공하는 서비스를 이용할 수 있는 자를 말합니다.
④ ‘비회원’이라 함은 회원에 가입하지 않고 “몰”이 제공하는 서비스를 이용하는 자를 말합니다.

제3조 (약관 등의 명시와 설명 및 개정) 
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자 등을 이용자가 쉽게 알 수 있도록 (주)Allight사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
④ “이용자”가 올린 “몰”에 게시한, 게시물은 “몰”에 소유권이 이전된다.
...
본 약관은 2020년08월01일부터 적용됩니다.
			</textarea>
		</div>
		<h4 class="tit" id="chk_cont2">개인정보 수집·이용</h4>
		<table border="" summary="구분, 목적, 항목, 보유기간, 필수정보, 선택정보" class="contract-tbl">
			...
			<tbody>
				<tr>
					...
					<td><div class="p10 itemsY">이름, 아이디, 비밀번호, 이메일, 휴대폰,
							생일, 성별</div></td>
		...
		<h4 class="tit" id="chk_cont3">개인정보 제3자 제공 (선택)</h4>
		<input type="hidden" name="agree_uidC" id="agree_uidC" value="2_">
		<table border="" summary="제공받는자, 목적, 항목, 보유기간" class="contract-tbl">
			...
			<tbody>
				<tr>
					<td><div class="p10 recipient2">우체국택배</div></td>
					<td><div class="p10 purpose2">주문상품 택배 배송</div></td>
					<td><div class="p10 items2">물류</div></td>
